function Fly(fid, type, color, sh, sw, x, y, fly_img, name) {
	...
	f.style.position = 'fixed' //"absolute";
...
$(document).ready(function () {
	...
	// var var_1 = 0;
	// alert(var_1);
	var var_1 = 'true' // bat tat ruoi
	// alert(var_1);
	var var_2 = 'false' // nhiu ruoi
	var var_3 = 'false' // nhiu ruoi
	...
	switch (value) {
		case 1:
			var fly = new Fly(
				...
				0,
				0,
				'https://anonyviet.com/resource/ruoibay/flies.png',
				'Long ruồi'
			)
			break
		case 2:
			var fly = new Fly(
				...
				0,
				0,
				'https://anonyviet.com/resource/ruoibay/style_1.png',
				'King ruồi'
			)
			break
		case 3:
			var fly = new Fly(
				...
				0,
				0,
				'https://anonyviet.com/resource/ruoibay/style_2.png',
				'Tom ruồi'
			)
			break
		case 4:
			var fly = new Fly(
				...
				0,
				0,
				'https://anonyviet.com/resource/ruoibay/style_3.png',
				'Queen ruồi'
			)
			break
	}
