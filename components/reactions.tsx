...
export default function Reactions({
	...
	return (
		<div className='inline-flex group relative'>
			...
			<div className='absolute transition-all delay-300 after:content-[""] after:absolute after:w-full after:h-[10%] invisible group-hover:visible opacity-0 bottom-1/2 group-hover:opacity-100 group-hover:bottom-[calc(110%)] left-1 z-10'>
