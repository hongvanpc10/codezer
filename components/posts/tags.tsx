...
export default function Tags() {
	...
	return (
		<div className='bg-white max-w-2xl mx-auto max-h-[calc(100vh-9rem)] px-2 py-4 rounded-3xl shadow-xl shadow-blue-900/5 flex flex-col'>
			<h2 className='ml-4 text-lg font-medium'>Tags</h2>

			<div className='flex-1 mt-3 overflow-y-auto scroll-xs'>
