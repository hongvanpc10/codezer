...
export const LikeSolidIcon = ({ className }: IconProps) => (
	<svg
		className={className}
		viewBox='0 0 24 24'
		fill='none'
...
export const SmileIcon = ({ className }: IconProps) => (
	...
	>
		...
		<ellipse fill='#ffda6b' cx='750.2' cy='751.1' rx='750' ry='748.8' />
...
export const SurpriseIcon = ({ className }: IconProps) => (
	<svg
		xmlns='http://www.w3.org/2000/svg'
		className={className}
		viewBox='0 0 1500 1500'
...
export const AngryIcon = ({ className }: IconProps) => (
	...
	>
		...
		<circle fill='url(#SVGID_1_)' cx='750' cy='750' r='750' />
