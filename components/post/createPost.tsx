...
export default function CreatePost() {
	...
	return user ? (
		<div className='bg-white/90 rounded-3xl px-5 pt-6 pb-4 shadow-lg shadow-blue-900/5'>
			...
			<div className='flex items-center'>
				<button className='flex-1 transition hover:bg-slate-100/50 font-medium justify-center py-2 rounded-xl flex items-center mr-1'>
					<GalleryBoldIcon className='h-7 mr-3 text-green-500' />
					Ảnh
				</button>
				<button className='flex-1 transition hover:bg-slate-100/50 font-medium justify-center py-2 rounded-xl flex items-center ml-1'>
